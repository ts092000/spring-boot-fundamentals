...
(
    ...
    CONSTRAINT pk_ticket_release PRIMARY KEY (release_fk ,ticket_fk)
);

ALTER TABLE ticket
    ADD CONSTRAINT FK_TICKET_ON_APPLICATION FOREIGN KEY (application_id) REFERENCES application (application_id);

ALTER TABLE ticket
    ADD CONSTRAINT FK_TICKET_ON_RELEASE FOREIGN KEY (release_id) REFERENCES release (id);
